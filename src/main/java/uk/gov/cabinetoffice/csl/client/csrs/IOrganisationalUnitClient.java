...
public interface IOrganisationalUnitClient extends ITaxonomyMapCacheClient<OrganisationalUnit, BasicTaxonomyNode, OrganisationalUnitMap, OrganisationalUnitDto> {
