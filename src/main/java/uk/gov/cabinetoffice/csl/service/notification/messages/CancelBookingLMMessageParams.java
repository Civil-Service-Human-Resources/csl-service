...
@Getter
public class CancelBookingLMMessageParams implements IEmail {
    ...
    public CancelBookingLMMessageParams(String recipient, String learnerName, String learnerEmail, String courseTitle,
    ...
    public EmailNotification getEmailNotification() {
        return EmailNotification.BOOKING_CANCELLED_LINE_MANAGER;
    }
