...
public class LearningCatalogueService {
    ...
    public CourseSearchResults getCoursesForLetter(String startsWith, Pageable pageableParams) {
        SearchForCoursesParams p = SearchForCoursesParams.builder().titleStartsWith(startsWith).status(List.of(CourseStatus.PUBLISHED)).visibility(List.of("PUBLIC")).build();
