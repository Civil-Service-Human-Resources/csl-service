...
import uk.gov.cabinetoffice.csl.domain.csrs.OrganisationalUnitIdDto;
...
public class UserProfileService {
    ...
    private User patchCivilServantOrganisation(String uid, Long organisationalUnitId) {
        civilServantRegistryService.patchCivilServantOrganisation(new OrganisationalUnitIdDto(organisationalUnitId));
